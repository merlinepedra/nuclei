...
on extensive configurability, massive extensibility and ease of use.`)
	...
	*/
	...
	flagSet.CreateGroup("cloud", "Cloud",
		...
		flagSet.StringVarEnv(&options.Webhook, "webhook-set", "whs", "", "WEBHOOK_URL", "Setup a webhook for the nuclei cloud accout"),
		flagSet.BoolVarP(&options.WebhookDelete, "webhook-del", "whd", false, "Delete the webhook for nuclei cloud account"),
	)
